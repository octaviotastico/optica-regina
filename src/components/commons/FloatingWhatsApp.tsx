  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <a
        ...
        aria-label="WhatsApp"
        className="flex items-center justify-center w-14 h-14 bg-green-500/50 hover:bg-green-500/90 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
        target="_blank"
